...
// import booksData from './books2.json';

// const allItems = booksData;
...
// function countCategoryOccurrences(objectsArray) {
//     // Create an empty object to store the category counts
//     const categoryCounts = {};
//     // Iterate through each object in the array
//     objectsArray.forEach(obj => {
//         // Iterate through each category in the categories array of the object
//         obj.authors.forEach(category => {
//             // obj.categories.forEach(category => {
//             // Convert the category to lowercase to ensure case insensitivity
//             category = category.toLowerCase();
//             // If the category is already in the object, increment its count
//             if (categoryCounts[category]) {
//                 categoryCounts[category]++;
//             } else {
//                 // Otherwise, add the category to the object with a count of 1
...
// }
// const objectsArray = [...booksData]
// const categoryCounts = countCategoryOccurrences(objectsArray);
// // Convert the category counts object to an array of key-value pairs
// const sortedCategoryCounts = Object.entries(categoryCounts).sort((a, b) => b[1] - a[1]);
// sortedCategoryCounts.forEach(obj => console.log(obj));
// // Creating the final array with the correct key-value pairs
// let finalArray = [];
// sortedCategoryCounts.forEach(obj => {
//     var language = obj[0];
//     var count = obj[1];
//     finalArray = [...finalArray, { [language]: count }];
// });
...
const Shopping = ({ product }) => {
    ...
    useEffect(() => {
        ...
        // console.log('triggered::::',finalProducts)
        ...
        <Card className="mb-4">
            ...
            <Card.Body>
                ...
                <Card.Text>
                    ...
                    {/* <span id="disc-price">{Math.floor(Math.random() * 1000)}</span>
